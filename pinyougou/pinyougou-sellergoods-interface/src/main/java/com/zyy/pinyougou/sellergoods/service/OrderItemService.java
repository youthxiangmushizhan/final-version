...
public interface OrderItemService extends CoreService<TbOrderItem> {
    ...
    List<TbOrderItem> getOrderItemByUserIdAndDate(String start, String end, String userId);

    PageBean<TbOrderItem> findOrderItemByPage(Integer pageNo, Integer pageSize, String start, String end, String userId);
}

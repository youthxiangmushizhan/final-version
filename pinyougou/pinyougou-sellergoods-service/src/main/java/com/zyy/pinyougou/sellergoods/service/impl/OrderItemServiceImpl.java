...
public class OrderItemServiceImpl extends CoreServiceImpl<TbOrderItem> implements OrderItemService {
    ...
    @Override
    public List<TbOrderItem> getOrderItemByUserIdAndDate(String start, String end, String userId) {
        Date date1 = null;
        Date date2 = null;
        try {
    ...
    @Override
    public PageBean<TbOrderItem> findOrderItemByPage(Integer pageNo, Integer pageSize, String start, String end, String userId) {
        List<TbOrderItem> list = getOrderItemByUserIdAndDate(start, end, userId);
        PageBean<TbOrderItem> pageBean = new PageBean<TbOrderItem>(pageNo,pageSize,list);

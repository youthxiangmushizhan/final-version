...
public class OrderItemController {
    ...
    @RequestMapping("/findOrderItemByUserId")
    public PageBean<TbOrderItem> findOrderItem(@RequestParam(value = "pageNo", defaultValue = "1", required = true) Integer pageNo,
                                               @RequestParam(value = "pageSize", defaultValue = "10", required = true) Integer pageSize,
                                               @RequestParam(value = "start", defaultValue = "", required = true) String start,
        ...
        return orderItemService.findOrderItemByPage(pageNo, pageSize, start, end, userId);
    }
